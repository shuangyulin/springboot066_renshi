<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考勤" prop="kaoqin">
          <el-input v-model="ruleForm.kaoqin" 
              placeholder="考勤" clearable  :readonly="ro.kaoqin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考勤" prop="kaoqin">
              <el-input v-model="ruleForm.kaoqin" 
                placeholder="考勤" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
